...
class Cart(Base):
    ...
    # ondelete="CASCADE" is used to delete all the cart items when the user is deleted
    user_id = Column(Integer, ForeignKey(User.id, ondelete="CASCADE"), )
    cart_items = relationship("CartItems", back_populates="cart")
    # back_populates is for the relationship in the other model. Mainly used for one-to-many relationships
